...
class Ui_OperatorWindow(object):
    def setupUi(self, OperatorWindow):
        ...
        OperatorWindow.setStyleSheet("font: 13pt \"American Typewriter\";\n"
    ...
    def retranslateUi(self, OperatorWindow):
        ...
        OperatorWindow.setWindowTitle(_translate("OperatorWindow", "lab4_sa"))
        self.start_button.setText(_translate("OperatorWindow", "Start"))
