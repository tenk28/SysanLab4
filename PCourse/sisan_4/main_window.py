...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(963, 643)
        Form.setStyleSheet("background-color: rgb(0, 195, 255);")
        ...
        self.exec_button.setStyleSheet("background-color: rgb(230, 249, 255); border-radius: 5px; padding:2px; font-size:15px;")
